...
type FakeStatefulSetUpdater struct {
	UpdateStub        func(string, *v1.Deployment) (*v1.Deployment, error)
...
func (fake *FakeStatefulSetUpdater) Update(arg1 string, arg2 *v1.Deployment) (*v1.Deployment, error) {
...
func (fake *FakeStatefulSetUpdater) UpdateCalls(stub func(string, *v1.Deployment) (*v1.Deployment, error)) {
	fake.updateMutex.Lock()
	defer fake.updateMutex.Unlock()
	fake.UpdateStub = stub
}

func (fake *FakeStatefulSetUpdater) UpdateArgsForCall(i int) (string, *v1.Deployment) {
	fake.updateMutex.RLock()
	defer fake.updateMutex.RUnlock()
