...
type FakeStatefulSetToLRPConverter struct {
	ConvertStub        func(v1.Deployment) (*opi.LRP, error)
...
func (fake *FakeStatefulSetToLRPConverter) Convert(arg1 v1.Deployment) (*opi.LRP, error) {
...
func (fake *FakeStatefulSetToLRPConverter) ConvertCalls(stub func(v1.Deployment) (*opi.LRP, error)) {
	fake.convertMutex.Lock()
